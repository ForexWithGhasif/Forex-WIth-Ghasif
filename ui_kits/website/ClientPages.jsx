...
function ClientDashboardPage() {
  ...
  const quickActions = [
    ['wallet', 'Trading Accounts', '/client/accounts', false],
...
/* Backtesting was removed for a rebuild — see git history (commits 2fafefd, 05d80fe,
   634def8) for the previous replay-terminal implementation (real Yahoo Finance data,
   date-range replay, drawing tools, account-gated simulated trading). */
function ClientBacktestingPage() {
  return <React.Fragment>
    ...
    <ClientComingSoon icon="line-chart" title="Backtesting" description="This workspace is being rebuilt — check back soon." />
  </React.Fragment>;
}
